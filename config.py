...
def parse_args():
    ...
    parser.add_argument('--train_data_path_list',
                        default='/content/drive/MyDrive/Retinal_Vessel_Segmentation/prepare_dataset/data_path_list/DRIVE/train.txt')
    parser.add_argument('--test_data_path_list',
                        default='/content/drive/MyDrive/Retinal_Vessel_Segmentation/prepare_dataset/data_path_list/DRIVE/test.txt')
    parser.add_argument('--train_patch_height', default=64)
    parser.add_argument('--train_patch_width', default=64)
    parser.add_argument('--N_patches', default=20000,
